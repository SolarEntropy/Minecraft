...
import com.solar.event.EventTick;
...
public class Minecraft implements IThreadListener, ISnooperInfo
{
    ...
    private void startGame() throws LWJGLException, IOException
    {
        ...
        Solar.getInstance().construct(this);
    ...
    private void runGameLoop() throws IOException
    {
        ...
        Solar.getInstance().update();

        EventTick eTick = new EventTick(Event.Type.PRE);
        Solar.getInstance().modManager().event(eTick);
    ...
    private void func_184118_az() throws IOException
    {
        while (Keyboard.next())
        {
            ...
            Solar.getInstance().inputManager().ingameKeyboard(Keyboard.getEventKeyState(), Keyboard.getEventKey(), Keyboard.getEventCharacter());
    ...
    private void func_184124_aB() throws IOException
    {
        while (Mouse.next())
        {
            ...
            Solar.getInstance().inputManager().ingameMouse(Mouse.getEventButtonState(), Mouse.getEventButton());
    ...
    private void middleClickMouse()
    {
        if (this.objectMouseOver != null && this.objectMouseOver.typeOfHit != RayTraceResult.Type.MISS)
        {
            ...
            else
            {
                ...
                int i = inventoryplayer.getFirstSlotForStack(itemstack);
                ...
                {
                    if (InventoryPlayer.isHotbarSlot(i))
                    {
