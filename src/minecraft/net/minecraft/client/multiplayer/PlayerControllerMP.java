...
import com.solar.hook.HEntityPlayerSP;
...
public class PlayerControllerMP
{
    ...
    public EnumActionResult func_187099_a(EntityPlayerSP p_187099_1_, WorldClient p_187099_2_, ItemStack p_187099_3_, BlockPos p_187099_4_, EnumFacing p_187099_5_, Vec3d p_187099_6_, EnumHand p_187099_7_)
    {
        ...
        else
        {
            ...
            if (!flag && this.currentGameType != WorldSettings.GameType.SPECTATOR)
            {
                ...
                else if (p_187099_1_.getCooldownTracker().hasCooldown(p_187099_3_.getItem()))
                {
                    return EnumActionResult.PASS;
                }
    ...
    public EnumActionResult func_187101_a(EntityPlayer p_187101_1_, World p_187101_2_, ItemStack p_187101_3_, EnumHand p_187101_4_)
    {
        ...
        else
        {
            ...
            if (p_187101_1_.getCooldownTracker().hasCooldown(p_187101_3_.getItem()))
            {
                return EnumActionResult.PASS;
            }
            else
    ...
    {
        return new HEntityPlayerSP(this.mc, worldIn, this.netClientHandler, statWriter);
    }
    ...
    public ItemStack clickWindow(int windowId, int slotId, int usedButton, ClickType mode, EntityPlayer player)
    {
        short short1 = player.openContainer.getNextTransactionID(player.inventory);
        ItemStack itemstack = player.openContainer.func_184996_a(slotId, usedButton, mode, player);
        this.netClientHandler.addToSendQueue(new CPacketClickWindow(windowId, slotId, usedButton, mode, itemstack, short1));
        return itemstack;
    }
