...
public class EntityRenderer implements IResourceManagerReloadListener
{
        ...
        if (entity != null)
        {
            if (this.mc.theWorld != null)
            {
                ...
                for (int j = 0; j < list.size(); ++j)
                {
                    ...
                    AxisAlignedBB axisalignedbb = entity1.getEntityBoundingBox().expand((double)entity1.getCollisionBorderSize());
    ...
    public void setupCameraTransformExtended(float partialTicks, int pass)
    {
    ...
    public void updateCameraAndRender(float partialTicks, long nanoTime)
    {
        ...
        if (this.mc.inGameHasFocus && flag && Solar.getInstance().guiManager().screen() == null)
        {
    ...
    private void renderWorldPass(int pass, float partialTicks, long finishTimeNano)
    {
        ...
        EventRender eRender = new EventRender(Event.Type.RENDER3D);
        Solar.getInstance().modManager().event(eRender);
        GlStateManager.popMatrix();
