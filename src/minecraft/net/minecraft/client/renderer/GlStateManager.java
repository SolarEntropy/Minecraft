...
public class GlStateManager
{
    ...
    public static boolean getAlpha() {
    	return alphaState.alphaTest.currentState;
    }
    ...
    public static boolean getLighting() {
    	return lightingState.currentState;
    }
    ...
    public static boolean getLight(int light) {
    	return lightState[light].currentState;
    }
    ...
    public static boolean getColorMaterial() {
    	return colorMaterialState.colorMaterial.currentState;
    }
    ...
    public static int getColorMaterialFace() {
    	return colorMaterialState.face;
    }
    
    public static int getcolorMaterialMode() {
    	return colorMaterialState.mode;
    }
    ...
    public static boolean getDepth() {
    	return depthState.depthTest.currentState;
    }
    ...
    public static boolean getBlend() {
    	return blendState.blend.currentState;
    }
    ...
    public static int getBlendFuncSrc() {
    	return blendState.srcFactor;
    }
    
    public static int getBlendFuncDst() {
    	return blendState.dstFactor;
    }
    ...
    public static int getBlendFuncSrcAlpha() {
    	return blendState.srcFactorAlpha;
    }
    
    public static int getBlendFuncDstAlpha() {
    ...
    public static boolean getPolygonOffset() {
    	return polygonOffsetState.polygonOffsetFill.currentState;
    }
    ...
    public static boolean getColorLogic() {
    	return colorLogicState.colorLogicOp.currentState;
    }
    ...
    public static boolean getTexGenCoord(GlStateManager.TexGen p_179100_0_) {
    	return texGenCoord(p_179100_0_).textureGen.currentState;
    }
    ...
    public static boolean getTexture2D() {
