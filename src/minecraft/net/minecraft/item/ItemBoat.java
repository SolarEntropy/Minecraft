...
public class ItemBoat extends Item
{
    ...
    public ActionResult<ItemStack> onItemRightClick(ItemStack itemStackIn, World worldIn, EntityPlayer playerIn, EnumHand hand)
    {
        ...
        else
        {
            ...
            boolean flag = false;
            List<Entity> list = worldIn.getEntitiesWithinAABBExcludingEntity(playerIn, playerIn.getEntityBoundingBox().addCoord(vec3d2.xCoord * d3, vec3d2.yCoord * d3, vec3d2.zCoord * d3).expand(1.0D));
            ...
            for (int i = 0; i < list.size(); ++i)
            {
                ...
                {
                    AxisAlignedBB axisalignedbb = entity.getEntityBoundingBox().expand((double)entity.getCollisionBorderSize());
            ...
            else
            {
                ...
                if (!worldIn.func_184144_a(entityboat, entityboat.getEntityBoundingBox().expand(-0.1D)).isEmpty())
                {
