...
public class InventoryPlayer implements IInventory
{
    ...
    {
        return isHotbarSlot(this.currentItem) ? this.mainInventory[this.currentItem] : null;
    }
    ...
    private boolean isItemMatch(ItemStack p_184436_1_, ItemStack p_184436_2_)
    {
        return p_184436_1_ != null && this.isItemMatchWithMeta(p_184436_1_, p_184436_2_) && p_184436_1_.isStackable() && p_184436_1_.stackSize < p_184436_1_.getMaxStackSize() && p_184436_1_.stackSize < this.getInventoryStackLimit();
    }

    private boolean isItemMatchWithMeta(ItemStack p_184431_1_, ItemStack p_184431_2_)
    {
    ...
    {
        int i = this.getFirstSlotForStack(p_184434_1_);
        ...
        else
        {
            ...
            {
                this.switchSlotWithCurrent(i);
            }
        }
    }

    public void switchSlotWithCurrent(int p_184430_1_)
    {
        this.currentItem = this.func_184433_k();
    ...
    public static boolean isHotbarSlot(int slotID)
    {
        return slotID >= 0 && slotID < 9;
    }

    public int getFirstSlotForStack(ItemStack stack)
    {
        for (int i = 0; i < this.mainInventory.length; ++i)
        {
            if (this.mainInventory[i] != null && this.isItemMatchWithMeta(stack, this.mainInventory[i]))
            {
                return i;
            }
        }
    ...
    {
        if (this.isItemMatch(this.getStackInSlot(this.currentItem), itemStackIn))
        {
            return this.currentItem;
        }
        else if (this.isItemMatch(this.getStackInSlot(40), itemStackIn))
        {
            return 40;
        }
        else
        {
            for (int i = 0; i < this.mainInventory.length; ++i)
            {
                if (this.isItemMatch(this.mainInventory[i], itemStackIn))
                {
                    return i;
                }
            }
    ...
    public void deleteAllItemsOfStack(ItemStack p_184437_1_)
    {
    ...
    public boolean canToolBreakBlock(IBlockState p_184432_1_)
    {
