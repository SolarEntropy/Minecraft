    ...
    public void onUpdate()
    {
        ...
        else
        {
            ...
            if (!this.worldObj.isRemote)
            {
                ...
                Entity entity = null;
                List<Entity> list = this.worldObj.getEntitiesWithinAABBExcludingEntity(this, this.getEntityBoundingBox().addCoord(this.motionX, this.motionY, this.motionZ).expand(1.0D));
                double d0 = 0.0D;
                ...
                for (int j = 0; j < list.size(); ++j)
                {
                    ...
                    {
                        AxisAlignedBB axisalignedbb1 = entity1.getEntityBoundingBox().expand(0.30000001192092896D);
