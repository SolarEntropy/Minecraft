...
public abstract class EntityArrow extends Entity implements IProjectile
{
    ...
    {
        Entity entity = null;
        List<Entity> list = this.worldObj.getEntitiesInAABBexcluding(this, this.getEntityBoundingBox().addCoord(this.motionX, this.motionY, this.motionZ).expand(1.0D), field_184553_f);
        double d0 = 0.0D;
        ...
        for (int i = 0; i < list.size(); ++i)
        {
            ...
            {
                AxisAlignedBB axisalignedbb = entity1.getEntityBoundingBox().expand(0.30000001192092896D);
