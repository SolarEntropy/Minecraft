...
public class EntityDragon extends EntityLiving implements IEntityMultiPart, IMob
{
        ...
        else
        {
            ...
            else
            {
                ...
                if (!this.worldObj.isRemote && this.hurtTime == 0)
                {
                    ...
                    this.attackEntitiesInList(this.worldObj.getEntitiesWithinAABBExcludingEntity(this, this.dragonPartHead.getEntityBoundingBox().expand(1.0D)));
                    this.attackEntitiesInList(this.worldObj.getEntitiesWithinAABBExcludingEntity(this, this.dragonPartNeck.getEntityBoundingBox().expand(1.0D)));
                }
    ...
    private void updateDragonEnderCrystal()
    {
        ...
        {
            List<EntityEnderCrystal> list = this.worldObj.<EntityEnderCrystal>getEntitiesWithinAABB(EntityEnderCrystal.class, this.getEntityBoundingBox().expand(32.0D));
